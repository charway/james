...
const RequestContextMenu = props => {
    const { request, handleContextMenu, showAddMapping, toggleMapping, removeMapping } = props
...
import { showAddUrlMapping, toggleUrlMapping, removeUrlMapping } from '../../../common/actions/url-mappings.js'
