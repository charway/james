...
const UrlMapping = props => {
    const { mapping, toggleActive, remove } = props
    ...
    return (
        <li className="collection-item">
            <div>
                <span className="col protocol">http(s)://</span>
                <span className="col text-ellipsis mask">{mapping.url}</span>
                <span className="seperator">
                    <i className="fa fa-chevron-right" />
                </span>
                <span className="col text-ellipsis new-url">{mapping.newUrl}</span>
