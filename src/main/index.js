...
const defaultIntegrations = sentryNode.defaultIntegrations.filter(
    integration => !(integration instanceof sentryNode.Integrations.OnUncaughtException)
)
...
app.on('ready', () => {
    ...
    mainWindow.webContents.on('did-finish-load', () => {
        ...
        browserLauncher.detect(available => {
            mainWindow.webContents.send('browsers-sync', available.filter(browser => browser.type !== 'phantomjs'))
        })
